 ...
 */
ByteBuffer::ByteBuffer(uint32_t size, bool network_endian) {
    buf.reserve(size);
    clear();
    this->network_endian = network_endian;
#ifdef BB_UTILITY
    name = "";
#endif
}
 ...
 */
ByteBuffer::ByteBuffer(uint8_t* arr, uint32_t size, bool network_endian) {
